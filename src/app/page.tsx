...
import { PageTitle, BodyText, SmallText } from '@/components/ui/typography'; // Using new Typography components
      ...
      <EnhancedCard className="w-full max-w-lg p-6 sm:p-8 md:p-10 text-center animate-card-entrance">
        <div className="flex flex-col items-center">
          <div className="mb-6 lg:mb-8 h-auto flex justify-center items-center">
            <Image
              src="/SG365_Final.svg" // Using the specified logo path
          ...
          <PageTitle as="h1" className="text-[#002455] !text-3xl sm:!text-4xl !mb-3"> {/* Adjusted PageTitle usage */}
            Protect Your<br />Countertops & Cabinets
          </PageTitle>
